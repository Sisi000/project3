                        ...
                        <div className="d-flex justify-content-around">
                            <Card className="bg-info text-dark bg-opacity-10" style={{ width: "18rem" }}>
                                ...
                                <Card.Body className='text-center mb-5'>
                                    <a href="http://localhost:3000/search?category=Aviator" target="_blank" rel="noreferrer">
                                        <Button type='button' className='shadow-none pt-2' variant="warning"><h3>AVIATOR</h3></Button></a>
                                </Card.Body>
                            </Card>
                        </div>
                    </Col>
                            ...
                            <Card className="bg-info text-dark bg-opacity-10" style={{ width: "18rem" }}>
                                ...
                                <Card.Body className='text-center mb-5'>
                                    <a href="http://localhost:3000/search?category=Round">
                                        <Button type='button' className='shadow-none mt-3 pt-2' variant="warning"><h3>ROUND</h3></Button></a>
                                </Card.Body>
                            </Card>
                        </div>
                    </Col>
                    <Col>
                        <div className="d-flex justify-content-around">
                            <Card className="bg-info text-dark bg-opacity-10" style={{ width: "18rem" }}>
                                ...
                                <Card.Body className='text-center mb-5'>
                                    <a href="http://localhost:3000/search?category=Rectangle">
                                        <Button type='button' className='shadow-none pt-2' variant="warning"><h3>RECTANGLE</h3></Button> </a>
                                </Card.Body>
                            </Card>
                        </div>
                    </Col>
                    <Col>
                        <div className="d-flex justify-content-around">
                            <Card className="bg-info text-dark bg-opacity-10" style={{ width: "18rem"}}>
                                ...
                                <Card.Body className='text-center mb-5'>
                                    <a href="http://localhost:3000/search?category=Oval">
                                        <Button type='button' className='shadow-none px-4 pt-2' variant="warning"><h3>OVAL</h3></Button> </a>
                                </Card.Body>
                            </Card>
                        </div>
                    </Col>
                    <Col>
                        <div className="d-flex justify-content-around">
                            <Card className="bg-info text-dark bg-opacity-10" style={{ width: "18rem"}}>
                                ...
                                <Card.Body className='text-center mb-5'>
                                    <a href="http://localhost:3000/search?category=Other">
                                        <Button type='button' className='shadow-none px-4 pt-2' variant="warning"><h3>OTHER</h3></Button> </a>
                                </Card.Body>
                            </Card>
                        </div>
                    </Col>
